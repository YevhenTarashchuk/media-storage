package com.media_storage.shared_data.constant;
...
public class ExceptionConstants {
    ...
    public static final String FILE_DATA_NOT_FOUND = "File data with id: %s not found for userId: %s";
    public static final String INVALID_MEDIA_URL = "Invalid media url: %s";
