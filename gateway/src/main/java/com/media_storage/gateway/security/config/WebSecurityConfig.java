package com.media_storage.gateway.security.config;


import com.media_storage.gateway.security.filter.JwtRequestFilter;
import com.media_storage.gateway.security.filter.LoginRequestFilter;
import com.media_storage.gateway.security.filter.RefreshTokenRequestFilter;
import com.media_storage.gateway.security.handler.AuthSuccessHandler;
import com.media_storage.gateway.security.provider.JwtAuthenticationProvider;
import com.media_storage.gateway.security.provider.LoginAuthenticationProvider;
import com.media_storage.gateway.security.provider.RefreshTokenAuthenticationProvider;
import com.media_storage.gateway.security.util.SkipPathRequestMatcher;
import com.media_storage.gateway.security.util.TokenExtractor;
...
@Configuration
@EnableWebSecurity
@ComponentScan("com.media_storage.*")
